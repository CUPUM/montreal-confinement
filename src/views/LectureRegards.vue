<template>
	...
	<div id="analyse-photo" class="view-scroll">
		...
		<div class="center-col">
			<p>Les résultats de la lecture paysagère se déclinent successivement en cinq (5) thèmes de caractérisation présentés ci-dessous sous la forme de nuage de mots qui identifient les principaux éléments prédominants dans une analyse descriptive (<i>composition visuelle</i>, <i>contexte urbain</i>, <i>présence humaine</i>) et sensible (<i>ambiance</i>, <i>sentiment/évocation</i>) de chaque <router-link tag="a" class="reference-link" :to="{name: 'Mediagraphie', hash: '#photo-index'}">cliché photographique</router-link>.</p>

			<h3>Composition visuelle</h3>
			<p>L’analyse visuelle révèle l’importance de l’éclairage naturel. La luminosité du <em><i>soleil</i></em> ressort comme un élément notable dans les compositions photographiques. Notons toutefois que cette prédominance du soleil n’est pas forcément synonyme de scènes lumineuses ou extérieures. La luminosité est aussi associée à la <em><i>lumière diffuse</i></em> et à quelques reprises à la <em><i>lumière directe</i></em>, voire <em><i>lumière artificielle</i></em>. Elle se traduit également par la <em><i>clarté</i></em>. La <em><i>fermeture rapprochée</i></em> du champ visuel constitue le deuxième élément dominant des cadrages analysés. Elle s’oppose à la profondeur de champ visuel, soit le <em><i>troisième plan</i></em>. Par ailleurs, les <em><i>vues axiales</i></em> sont reliées aux voies de transport</p>
		</div>
		...
		<div class="center-col">
			...
			<p>Le <em><i>métro</i></em>, la <em><i>rue</i></em> et le <em><i>trottoir</i></em> constituent les trois éléments physiques repérés le plus fréquemment dans l’échantillon de clichés photographiques. En ce qui concerne le <em><i>métro</i></em>, l’intérêt des photographes semble s’orienter autant vers des scènes dans les <em><i>stations</i></em> que dans les <em><i>voitures</i></em>. Dans l’ensemble des photographies, les <em><i>rues</i></em> se définissent plus spécifiquement en tant que <em><i>rues vides</i></em> et <em><i>rues commerciales</i></em> où une <em><i>absence de circulation automobile</i></em> règne. Les <em><i>trottoirs</i></em>, bien que souvent identifiés, sont seulement caractérisés à quelques reprises, et ce par le qualificatif «{{'\xa0'}}<em><i>étroit</i></em>{{'\xa0'}}». Par ailleurs, il est à noter que les clichés accordent une importance, d’une part, aux <em><i>façades</i></em> qui côtoient les diverses voies de circulation repérées et, d’autre part, aux <em><i>intersections</i></em> entre ces voies. Le <em><i>centre-ville</i></em> de Montréal est le secteur urbain privilégié dans les cadrages photographiques.</p>
		</div>
		<div class="wordcloud-container">
			<WordCloud
				:chartID="'wordcloud2'"
