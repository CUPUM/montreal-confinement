<template>
	...
	<div id="contexte" class="view-scroll">
		...
		<div class="center-col">
			...
			<p>
				<ul>
					<li>de tirer des constats sur les enjeux du paysage urbain montr&eacute;alais (r&eacute;f.{{'\xa0'}}: espaces publics) &agrave; partir des pr&eacute;occupations journalistiques, celles de certains OBNL pertinents envers le sujet et celles &eacute;mises par le milieu municipal dans cette phase de confinement{{'\xa0'}};</li>
					<li>d&rsquo;interpr&eacute;ter le regard de photographes de presse envers l&rsquo;espace public montr&eacute;alais.</li>
				</ul>
			</p>
			<p>Les r&eacute;sultats issus de ces deux objectifs sont pr&eacute;sent&eacute;s successivement dans les pages suivantes. De plus, ceux-ci int&eacute;greront <a class="reference-link" href="https://en.unesco.org/covid19/initiatives">la carte interactive de l&rsquo;UNESCO</a> qui r&eacute;pertorie les exp&eacute;riences des villes &agrave; travers les r&eacute;seaux de l&rsquo;UNESCO (r&eacute;f.{{'\xa0'}}: <a class="reference-link" href="https://fr.unesco.org/system/files/unesco_cities_leaflet_fr_print_v2.pdf">Plateforme des villes de l&rsquo;UNESCO</a>) pour susciter et promouvoir la collaboration et la solidarit&eacute; &agrave; l&rsquo;&eacute;chelle internationale.</p>

			<h3>&Eacute;quipe de recherche</h3>
			<h4>Direction scientifique</h4>
			<p>
				<ul>
					<li>Philippe Poullaouec-Gonidec,<br><i>professeur et titulaire de la Chaire UNESCO en paysage urbain (CUPUM)</i></li>
				</ul>
			</p>
			<h4>Chercheurs</h4>
			<p>
				<ul>
					<li>Emmanuel Beaudry Marchand,<br><i>agent de recherche &mdash; Chaire UNESCO en paysage urbain (CUPUM)</i></li>
